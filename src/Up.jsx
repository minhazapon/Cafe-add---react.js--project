  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
            ...
            <div  className=" bg-slate-100  border-[1px] border-[#AF8260] p-5 rounded-xl" >
                      ...
                      <div>
                        ...
                        <p className=" text-center mt-3 text-2xl">Rise and grind, its coffee time!</p>
                 ...
                 <div className="  flex-col md:flex-row lg:flex-row   ">
                  <input className="  text-white mt-4 btn w-[720px] bg-[#AF8260]" type="submit" value="Update Existing Coffee Details" />      
                 </div>
                 </div>
